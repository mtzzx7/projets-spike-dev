...
"""
colorE = ColorSensor('E') #Ajuste as portas do sensor ate que correspondam a sua configuracao, recomendamos atribuir suas portas a's do programa para facilitar o uso
